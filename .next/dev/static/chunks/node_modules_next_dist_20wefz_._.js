...
_export(exports, {
    createClientParams: function createClientParams() {
        return _paramsbrowser.createRenderParamsFromClient;
    },
    createClientSearchParams: function createClientSearchParams() {
        return _searchparamsbrowser.createRenderSearchParamsFromClient;
    }
});
var _paramsbrowser = __turbopack_context__.r("[project]/node_modules/next/dist/client/request/params.browser.js [app-client] (ecmascript)");
var _searchparamsbrowser = __turbopack_context__.r("[project]/node_modules/next/dist/client/request/search-params.browser.js [app-client] (ecmascript)");
if ((typeof exports.default === 'function' || _type_of._(exports.default) === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
var _clientboundaryparams = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/client-boundary-params.browser.js [app-client] (ecmascript)");
function ClientPageRoot(param) {
    ...
    var clientSearchParams = (0, _clientboundaryparams.createClientSearchParams)(searchParams);
    var clientParams = (0, _clientboundaryparams.createClientParams)(params);
...
_export(exports, {
    InstantValidationBoundaryContext: function InstantValidationBoundaryContext() {
        return _impl.InstantValidationBoundaryContext;
    },
    PlaceValidationBoundaryBelowThisLevel: function PlaceValidationBoundaryBelowThisLevel() {
        return _impl.PlaceValidationBoundaryBelowThisLevel;
    },
    RenderValidationBoundaryAtThisLevel: function RenderValidationBoundaryAtThisLevel() {
        return _impl.RenderValidationBoundaryAtThisLevel;
    },
    SlotMarker: function SlotMarker() {
        return _impl.SlotMarker;
    }
});
var _impl = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/instant-validation/impl.browser.js [app-client] (ecmascript)");
if ((typeof exports.default === 'function' || _type_of._(exports.default) === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
_export(exports, {
    InstantValidationBoundaryContext: function InstantValidationBoundaryContext1() {
        return InstantValidationBoundaryContext;
    },
    PlaceValidationBoundaryBelowThisLevel: function PlaceValidationBoundaryBelowThisLevel1() {
        return PlaceValidationBoundaryBelowThisLevel;
    },
    RenderValidationBoundaryAtThisLevel: function RenderValidationBoundaryAtThisLevel1() {
        return RenderValidationBoundaryAtThisLevel;
    },
    SlotMarker: function SlotMarker1() {
        return SlotMarker;
    }
});
var InstantValidationBoundaryContext = null;
var PlaceValidationBoundaryBelowThisLevel = null;
var RenderValidationBoundaryAtThisLevel = null;
var SlotMarker = null;
if ((typeof exports.default === 'function' || _type_of._(exports.default) === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
...
var _boundary = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/instant-validation/boundary.js [app-client] (ecmascript)");
...
var enableNewScrollHandler = ("TURBOPACK compile-time value", true);
 ...
 */ function getScrollPaddingTopInPixels(htmlElement, viewportHeight) {
    var scrollPaddingTop = getComputedStyle(htmlElement).scrollPaddingTop;
    var value = Number.parseFloat(scrollPaddingTop);
 ...
 */ function getHashFragmentDomNode(hashFragment) {
    var _ref, _document_getElementById;
    // If the hash fragment is `top` the page has to scroll to the top of the page.
    if (hashFragment === 'top') {
        return document.body;
    }
    // If the hash fragment is an id, the page has to scroll to the element with that id.
    return (_ref = (_document_getElementById = document.getElementById(hashFragment)) !== null && _document_getElementById !== void 0 ? _document_getElementById : // If the hash fragment is a name, the page has to scroll to the first element with that name.
    document.getElementsByName(hashFragment)[0]) !== null && _ref !== void 0 ? _ref : null;
}
    ...
    function InnerScrollAndFocusHandlerOld() {
        ...
        _this = _call_super._(this, InnerScrollAndFocusHandlerOld, _to_consumable_array._(args)), _this.handlePotentialScroll = function() {
            ...
            (0, _disablesmoothscroll.disableSmoothScrollDuringRouteTransition)(function() {
                ...
                var scrollPaddingTop = null;
                var getScrollPaddingTop = function getScrollPaddingTop() {
 ...
 */ function InnerScrollHandlerNew(props) {
    ...
    (0, _react.useLayoutEffect)(function() {
        ...
        var didHandleScroll = false;
        (0, _disablesmoothscroll.disableSmoothScrollDuringRouteTransition)(function() {
            var htmlElement = document.documentElement;
            var viewportHeight = null;
            var initialTargetState = null;
            var scrollPaddingTop = null;
            var getScrollPaddingTop = function getScrollPaddingTop() {
                if (scrollPaddingTop === null) {
...
var InnerScrollAndMaybeFocusHandler = ("TURBOPACK compile-time truthy", 1) ? InnerScrollHandlerNew : "TURBOPACK unreachable";

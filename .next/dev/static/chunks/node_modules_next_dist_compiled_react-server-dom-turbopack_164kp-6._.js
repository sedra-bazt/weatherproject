        ...
        switch(reference.status){
            case "fulfilled":
                for(var value = reference.value, i = 1; i < path.length; i++){
                    ...
                    var name = path[i];
                    if ("object" !== (typeof value === "undefined" ? "undefined" : _type_of._(value)) || null === value || getPrototypeOf(value) !== ObjectPrototype && getPrototypeOf(value) !== ArrayPrototype || !hasOwnProperty.call(value, name)) throw Error("Invalid reference.");
                    value = value[name];
                }
                for(; "object" === (typeof value === "undefined" ? "undefined" : _type_of._(value)) && null !== value && value.$$typeof === REACT_LAZY_TYPE;){
                    path = value._payload;
